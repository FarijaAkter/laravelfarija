                        ...
                        <div class="col-6 form-group">
                            <div class="custom-control custom-radio">
                                ...
                                <label for="shipping-company-{{ $shippingCompany->id }}"
                                    ...
                                    <small>
                                        {{ $shippingCompany->description }} (Tk. {{ $shippingCompany->cost }})
                                    </small>
                                </label>
                            </div>
                        </div>
                ...
                <div class="your-order-table table-responsive">
                    <table>
                        ...
                        <tr>
                            ...
                            <th class="product-total">Tk. {{ $cartSubTotal }}</th>
                        </tr>
                        @if(session()->has('coupon'))
                            <tr>
                                <th class="product-name">
                                ...
                                <th class="product-total">- Tk. {{ $cartDiscount }}</th>
                            </tr>
                        @endif
                        @if(session()->has('shipping'))
                            <tr>
                                ...
                                <th class="product-total">Tk. {{ $cartShipping }}</th>
                            </tr>
                        @endif
                        <tr>
                            <th class="product-name">
                            ...
                            <th class="product-total">Tk. {{ $cartTax }}</th>
                        </tr>
                        <tr class="order-total">
                            ...
                            <td>
                                <strong><span>Tk. {{ $cartTotal }}</span></strong>
                            </td>
                        </tr>
                        </tbody>
                    </table>
